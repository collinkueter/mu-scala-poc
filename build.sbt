...
val protocol = project
  .settings(
    name := "mu-scala-poc-protocol",
    libraryDependencies ++= Seq(
      // Needed for the generated code to compile
      "io.higherkindness" %% "mu-rpc-service" % "0.26.0"
    ),
...
val server = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.higherkindness" %% "mu-rpc-testing" % "0.26.0" % Test
    ),
